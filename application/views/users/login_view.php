...
<body>
    <div class="container">
        <section id="content">
            ...
            <h1>Cars-On-Rent Login Form</h1>
            <div>
                <?php

                echo form_open('Users/login_action');
                ...
                ?>
                <hr>
                <a href='<?php echo base_url() . "index.php/Register/Registers/index"; ?>'>Not Registered Yet? Click Here</a>
                <hr>
                <br>
        </section><!-- content -->
    </div><!-- container -->
